...
class CustomerApi(object):
    ...
    def delete_customer_with_http_info(self, customer_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{customer_token_id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_customer_with_http_info(self, customer_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{customer_token_id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_customer_with_http_info(self, customer_token_id, patch_customer_request, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{customer_token_id}', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
