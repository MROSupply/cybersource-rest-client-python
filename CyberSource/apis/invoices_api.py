...
class InvoicesApi(object):
    ...
    def get_invoice_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/invoicing/v2/invoices/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def perform_cancel_action_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/invoicing/v2/invoices/{id}/cancelation', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def perform_send_action_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/invoicing/v2/invoices/{id}/delivery', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_invoice_with_http_info(self, id, update_invoice_request, **kwargs):
        ...
        return self.api_client.call_api('/invoicing/v2/invoices/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
